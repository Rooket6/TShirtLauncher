...
public class Chassis extends Subsystem {
    ...
    SpeedController leftBack = RobotMap.chassisleftBack;
    SpeedController rightFront = RobotMap.chassisrightFront;
    SpeedController rightBack = RobotMap.chassisrightBack;
   ...
   public void arcade(Joystick joystickJuan){
	   drivetrain.arcadeDrive(joystickJuan);
   }
